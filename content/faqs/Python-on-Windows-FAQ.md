...
许多人把交互模式当作方便和高度可编程的计算器。 想结束交互式Python会话时，调用 [`exit()`](https://docs.python.org/zh-cn/3.11/library/constants.html#exit) 函数，或者按住 Ctrl 键时输入 Z ，之后按 Enter 键返回Windows命令提示符。
