...
title = "接下来？"
weight = 130
date = 2023-06-26T19:44:13+08:00
type = "docs"
description = ""
isCJKLanguage = true
draft = false
...
- [安装 Python 模块](https://docs.python.org/zh-cn/3.11/installing/index.html#installing-index) 解释了怎么安装由其他Python开发者编写的模块。

- [Python 语言参考手册](https://docs.python.org/zh-cn/3.11/reference/index.html#reference-index): Python的语法和语义的详细解释。尽管阅读完非常繁重，但作为语言本身的完整指南是有用的。
...
- [https://pypi.org](https://pypi.org/): The Python Package Index，以前也被昵称为 Cheese Shop [1](https://docs.python.org/zh-cn/3.11/tutorial/whatnow.html#id2)，是可下载用户自制 Python 模块的索引。 当你要开始发布代码时，你可以在此处进行注册以便其他人能找到它。
...
在发问之前，请务必查看以下列表 [常见问题](https://docs.python.org/zh-cn/3.11/faq/index.html#faq-index) （或简写为 FAQ）。常见问题包含了很多一次又一次问到的问题及答案，并且可能已经包含了您的问题的解决方案。

备注

- [1](https://docs.python.org/zh-cn/3.11/tutorial/whatnow.html#id1)
